            ...
            child: InkResponse(
              ...
              child: CircleAvatar(
                ...
                child: Icon(
                  ...
                  size: widget.radius != null ? widget.radius! / 3.5 : 0,
                ),
              ),
            ),
          ),
                  ...
                  try {
                    ...
                    await ImagePickerCropper.pickAndCropWithCallback(
                      ...
                      onCompleted: (file, bytes) {
                        setState(() {
                          if (kIsWeb) {
                            ...
                            image = file != null ? File(file) : null;
                            widget.onPickerChange?.call(File(file!));
                          }
                          // Call new callbacks
                          widget.onPickerCompleted?.call(
                      ...
                      onFileCompleted: (file) {
                        widget.onFilePickerCompleted?.call(File(file));
                      },
